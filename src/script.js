...
function set_form_values(form, formData) {
    ...
    try {
        form.getFields().forEach(current_field => {
            ...
            else if (current_field_name === mapper.getPdfField("previousResidenceMunicipality")) {
                set_field_text(current_field, formData.previousResidenceMunicipality);
            }
            ...
            else if (current_field_name === mapper.getPdfField("deregistrationStaircase")) {
                set_field_text(current_field, formData.deregistrationStaircase);
            }
            else if (current_field_name === mapper.getPdfField("deregistrationApartmentNumber")) {
                set_field_text(current_field, formData.deregistrationApartmentNumber);
            }
            else if (current_field_name === mapper.getPdfField("deregistrationPostalCode")) {
                set_field_text(current_field, formData.deregistrationPostalCode);
            }
